/***************************************************************************
                          origingapparser.cpp  -  description
                             -------------------
...
OriginGapParser::OriginGapParser(){
  ...
  GAP = new Vector3D<float>(0.0, 0.0, 0.0);
}
OriginGapParser::~OriginGapParser(){
  delete A;
  delete C;
...
/** Wcurve algorithm */
bool OriginGapParser::convertNucleotide(Vector3D<float> *prevNuc,
...
void OriginGapParser::setGamma(float newG){
  gamma = newG;
